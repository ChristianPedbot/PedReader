  ...
  return (
    <div>
      <div className="cards-list">
        <Link to="/books/categorie/14" className="genre-link" reloadDocument>
        ...
        <Link to="/books/categorie/15" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/16" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/17" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/18" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/19" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/20" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/21" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/22" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/23" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/24" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
        ...
        <Link to="/books/categorie/25" className="genre-link" reloadDocument>
          <div className="card-genres">
            <div className="card_image">
